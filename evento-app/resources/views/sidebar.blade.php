...
<div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
    <div
        ...
        <span class="hidden md:block">@if(\Illuminate\Support\Facades\Auth::getUser()->hasRole('admin')) {{ 'Admin' }} @elseif(\Illuminate\Support\Facades\Auth::getUser()->hasRole('organizer')) {{ 'Organizer' }}@endif</span>
    </div>
